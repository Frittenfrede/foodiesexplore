...
class Restaurant{
  ...
  Restaurant({this.name, this.country,this.city,this.postalCode,this.street,this.streetNumber,this.checkincode,this.coordinates,this.rating,this.reviews,this.priceClass,this.photos,this.id});
