  ...
  Widget build(BuildContext context) {
    return Scaffold(
          body: Column(
            children: [
              SizedBox(height: 26,),
              GestureDetector(child: Text(widget.resreview.restaurant.name,style: TextStyle(fontSize: 20),),onTap: (){
                Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) =>  RestaurantPage(restaurant: widget.resreview.restaurant))
              ,);}),
                    ...
                    child: Row(
                      children: [
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: NetworkImage(widget.resreview.foodie.picturePath),fit: BoxFit.fill)),
                        ),
                        Container(
