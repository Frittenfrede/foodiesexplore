...
class _Home extends State<Home> {
  ...
  void initState() {
    ...
    // Hardcoded da det kun er Aarhus der har test data 
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      ResReviewView(resreview: reviews[index])),
                            );
                          },
                          child: Padding(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          ...
                                          child: Text(reviews[index]
                                                      ...
                                                      .length >
                                                  40
                                              ? '${reviews[index].review.substring(0, 40)}...'
                                ...
                                child: ListTile(
                                  title: Column(
                                    children: [
                                      Center(
                                          child: Text(
                                              checkIns[index].restaurant.name)),
                                      Center(
                                        child: Text(
                                            checkIns[index].time.toString()),
                                      ),
                                    ],
                                  ),
                                  onTap: () async{
                                    // Checks whether the review was uploaded or aborted
                                      ...
                                      new MaterialPageRoute(
                                          builder: (context) =>
                                              new ReviewScreen(
                                                ...
                                                restaurant:
                                                    checkIns[index].restaurant,
                                              )),
                                    );
                                  if(accepted != null){
                                    setState(() {
                                    //Updates the Review screen UI not showing the deleted checkin
                                    _checkins = _database.getUserCheckIn();
                                  });
                                  }
