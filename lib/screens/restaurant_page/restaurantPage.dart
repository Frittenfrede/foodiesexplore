...
return Container(
                    decoration: new BoxDecoration(
                     ...
                     child: Image.network(review.photos[0],fit: BoxFit.fill,));             
}
  ...
  return Row(
    children: [Container(
      ...
      Container(
                        decoration: new BoxDecoration(
                         ...
                         child: Image.network(review.photos[1],fit: BoxFit.fill,)),
    ],
  ); 
}
  else if(review.photos.length > 2){
      ...
      children: [
        Container(
                    ...
                    decoration: new BoxDecoration(
                     ...
                     child: Image.network(review.photos[2],fit: BoxFit.fill,)), 
      ],
    ); 
    ...
    return Container(
     ...
     children: [
       ...
       CarouselSlider(
  options: CarouselOptions(height: MediaQuery.of(context).size.height * 0.3,autoPlay: true),
...
Padding(
  ...
  child:   Row(
      ...
      children: [
      Text(widget.restaurant.name,style: TextStyle(fontFamily: 'montserrat',fontSize: 20,fontWeight: FontWeight.normal)),
      Text(widget.restaurant.rating.toString(), style: TextStyle(fontFamily: 'montserrat', fontSize: 48,fontWeight: FontWeight.bold),)
      ],
...
Align(
  ...
  child: Padding(
      ...
      child: Text(widget.restaurant.city + " " + widget.restaurant.country ,style: TextStyle(fontFamily: 'montserrat',fontSize: 18,fontWeight: FontWeight.normal)),
  )),
Align(
  alignment: Alignment.centerLeft,
  child: Padding(
      padding: const EdgeInsets.all(8.0),
      child: Text(widget.restaurant.street + " " + widget.restaurant.streetNumber,style: TextStyle(fontFamily: 'montserrat',fontSize: 18,fontWeight: FontWeight.normal)),
  )),
...
builder: (BuildContext context, AsyncSnapshot<List<RestaurantReview>> snapshot) {
    ...
    return Card(child: Container(
      ...
      child: Row(
         ...
         SizedBox(width: MediaQuery.of(context).size.width *0.080,),
          Container(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
       children: [
                 Text(reviews[index].header, style: TextStyle(fontWeight: FontWeight.bold),),
                       SmoothStarRating(
                 rating: reviews[index].rating,
                 isReadOnly: false,
                 size: 24,
                 filledIconData: Chef_hats.Chef_hat.chef_hat,
                 halfFilledIconData: Chef_hats.Chef_hat.chef_hat,
                 ...
                 Container(
                   width: MediaQuery.of(context).size.width *0.7,
                   child: Text(reviews[index].review.length > 80 ? '${reviews[index].review.substring(0, 80)}...' : reviews[index].review)),
